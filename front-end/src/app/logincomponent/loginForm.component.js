...
var LoginComponent = (function () {
    ...
    /**
     * Initiating authentication in login component by fetching userID.
     * check whether user is loggedIn or loggedOut.
     */
    ...
    /**
     * Logging In user by submitting email and password.
     */
    LoginComponent.prototype.onSubmit = function (values) {
        ...
        if (this.form.valid) {
            ...
            result.subscribe(function (logindata) {
                ...
                toast.innerHTML = helpers_1.PATHS.PASS_MSG;
                setTimeout(function () {
